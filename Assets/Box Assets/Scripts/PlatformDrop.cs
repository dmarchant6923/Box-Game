...
public class PlatformDrop : MonoBehaviour
{
    ...
    void Update()
    {
        //Debug.Log("spinDropTimer: "+spinDropTimer+". collider enabled: " + GetComponent<BoxCollider2D>().enabled);
    ...
    IEnumerator Shock()
    {
        ...
        while (timer1 < window1 && shockActive)
        {
            if (timer2 > window2)
            {
                ...
                newLightning.GetComponent<Lightning>().pointsPerUnit = 2;
    ...
    IEnumerator ShockFlash()
    {
        ...
        while (shockActive)
        {
            ...
            yield return new WaitForSeconds(window2 + Random.Range(0, window2));
            GetComponent<SpriteRenderer>().color = initialColor;
            yield return new WaitForSeconds(window1 + Random.Range(0, window1));
        }
        GetComponent<SpriteRenderer>().color = initialColor;
    }
